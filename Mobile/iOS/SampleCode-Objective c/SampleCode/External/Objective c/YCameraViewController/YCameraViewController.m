...
- (void)viewDidLoad
{
    ...
    //imgPicker.cameraViewTransform = CGAffineTransformScale(imgPicker.cameraViewTransform, 1, 1);
    //CGRect myRect = CGRectMake(imgPicker.view.frame.origin.x, 84, screenWidth - 20, screenHeight- 64 - 20);
    //imgPicker.view.frame = myRect;
    ...
    NSLog(@"imgPicker.view.frame.origin.x = %f",imgPicker.view.frame.origin.x);
    NSLog(@"imgPicker.view.frame.origin.y = %f",imgPicker.view.frame.origin.y);
    
    _imagePreview.frame = CGRectMake(imgPicker.view.frame.origin.x, 84, screenWidth - 20, screenHeight- 64 - 20 - 84);
    _captureImage.frame = CGRectMake(imgPicker.view.frame.origin.x, 84, screenWidth - 20, screenHeight- 64 - 20 - 84);
    _ImgViewGrid.frame = CGRectMake(imgPicker.view.frame.origin.x, 84, screenWidth - 20, screenHeight- 64 - 20 - 84);
}
...
- (void)showControllers{
    [UIView animateWithDuration:0.2 animations:^{
        self.photoBar.center = CGPointMake(self.photoBar.center.x, self.photoBar.center.y-116.0);
        _photoBar.layer.borderWidth = 2;
        _photoBar.layer.borderColor = [UIColor greenColor].CGColor;
        self.topBar.center = CGPointMake(self.topBar.center.x, self.topBar.center.y+64.0);
    } completion:nil];
}
